...
useEffect (() => {
  ...
  return (
    <>
      <header className={`absolute top-0 left-0 w-full mt-6 z-10 ${isFixed ? "scrolling top-0 left-0 z-50" : ""}`}>
      ...
      <div className='mobileheader'>
        <div className="container mx-auto px-4 lg:px-10 py-4 flex items-center justify-between">
          ...
          <nav
            className={`${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 absolute lg:static left-0 top-0 w-3/4 lg:w-auto bg-[#0d1117] lg:bg-transparent transition-transform duration-300 ease-in-out z-40`}
          >
