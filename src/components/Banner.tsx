...
const words = ["Web Developer", "Professional Coder.", "Designer.", "React Developer"];
                ...
                <div className='grid grid-cols-2 items-center justify-items-end'>
                    <div className='banner_content'>
                        <div className='inner'>
                            ...
                            <div className='grid grid-cols-2 mt-5'>
                                ...
                                <p>BEST SKILL ON</p>
                                    <ul className='hero_icons list-insidelist-none p-0 inline-flex space-x-4 mt-5'>
                                        <li><a href='#'><Image src={IMAGES.ATOM} width={100} height={100} alt='Icons'/></a></li>
                                        <li><a href='#'><Image src={IMAGES.WORDPRESS} width={100} height={100} alt='Icons'/></a></li>
                                        <li><a href='#'><Image src={IMAGES.PHOTOSHOP} width={100} height={100} alt='Icons'/></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='thumbnail'>
                        <div className='inner_imgs relative block max-w-lg mx-auto'>
                            <Image className='w-full max-w-md h-full mx-auto' src={IMAGES.BANNER} width={500} height={500} alt={'My Self'} />
                        </div>
                    </div>
                </div>
            </div>
