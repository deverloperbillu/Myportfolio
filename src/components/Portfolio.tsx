                    ...
                    return(
                        <div className='project_card p-5 rounded-lg' key={index} onClick={() => handleProjectClick(project.id)}>
                            ...
                            <div className='project_img rounded-lg overflow-hidden'>
                                <figure>
                                    <Image src={project.portfolioSrc} className='min-h-[220px] object-cover h-[220px] object-top rounded-lg ease-linear duration-300' width={500} height={500} alt='Project Images' />
                                </figure>
                            </div>
                    ...
                    <a href="#" className="cls-project absolute top-5 right-5 inline-block w-[50px] h-[40px] bg-black" onClick={closepopup}></a>
                      <div className='grid grid-cols-2 gap-4'>
                          <div className='project-gallery'>
                            <figure><Image className='h-[400px] object-top object-cover w-full rounded-lg' src={selectedProject.ourworkprojectsSrc} width={500} height={500} alt={selectedProject.ourworkprojectsTitle} /></figure>
                          </div>
